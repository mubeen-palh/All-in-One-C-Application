...
bool isSafe(int arr[n][n], int row, int column, int number)
{
...
bool findemptyplace(int arr[n][n], int &row, int &column)
{
    for (row = 0; row < n; row++)
    {
...
bool SolveSudoko(int arr[n][n], int row, int column)
{
...
void removevaluesfrommatrix(int mat[n][n], int k)
{
    int count = 0;
...
void matrixgen(int sud[n][n], int sol[n][n], int x)
{
...
void takeinput(int sud[n][n], int sol[n][n])
{
    bool flag = 0;
    int x, y;
